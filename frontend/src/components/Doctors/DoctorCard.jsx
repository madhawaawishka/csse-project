  ...
  return (
    <div className='p-3 lg:p-5'>
        ...
        <div className="flex items-center justify-between mt-2 lg:mt-4">
            <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-{12px} leading-4 lg:text-[16px] font-semibold lg:leading-7 rounded'>{specialization} </span>
